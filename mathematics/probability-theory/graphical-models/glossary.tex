...
\longnewglossaryentry{feature function}{name=feature function}
{%
...
\longnewglossaryentry{probabilistic graphical model}{name=probabilistic graphical model}
{%
  %TODO
}

\longnewglossaryentry{bayesian network}{name=Bayesian network}
{%
  %TODO
}

\longnewglossaryentry{linear-chain crf}{name=linear-chain CRF}
{%
  A \acrfull{crf} \dots
  %TODO
}

\longnewglossaryentry{generative model}{name=generative model}
{%
  %TODO
}

\longnewglossaryentry{discriminative model}{name=discriminative model}
{%
  %TODO
}
...
\newacronym{crf}{CRF}{\glslink{conditional random field}{conditional random field}}
